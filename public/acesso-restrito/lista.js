        ...
        response.json().then(data => {
            if ('message' in data) {
                ...
                for (let i = 0; i < data.length; i++) {
                    if(data[i].realized == 0){
                    list.innerHTML += ` <li class=" my-3 py-3 list-group-item " id="list${data[i].id}">
                    <div class="row">
                    <div class="col-1">
                    <input class="" type="checkbox" id="check${data[i].id}" onclick="done(${data[i].id})">
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        <span class=" h5 text-decoration-line-through" id="text${data[i].id}"> ${data[i].name} </span>
                    </div>
                    <div class="col-4">
                        <i class=" fa fa-trash" style="cursor:pointer;" onclick="deleteList(${data[i].id})"></i>
                        <i class="fa fa-thin fa-pencil" style="cursor:pointer;" onclick="editList(${data[i].id}, '${data[i].name}', ${data[i].realized})"></i>
